...
>>   --write-metadata --write-tags `
>>   --sleep 3-7 --sleep-request 10-20 `
>>   "https://www.instagram.com/explore/tags/gtavonline/" `
>>   --filter "extension in ('jpg', 'jpeg', 'png', 'webp')"
```
...
>>   --write-metadata --write-tags `
>>   --sleep 3-7 --sleep-request 10-20 `
>>   "https://www.instagram.com/explore/tags/mortalkombat/" `
>>   --filter "extension in ('jpg', 'jpeg', 'png', 'webp')"
```
...
>>   --write-metadata --write-tags `
>>   --sleep 3-7 --sleep-request 10-20 `
>>   "https://www.instagram.com/explore/tags/happytreefriends/" `
>>   --filter "extension in ('jpg', 'jpeg', 'png', 'webp')"
```
...
>>   --write-metadata --write-tags `
>>   --sleep 3-7 --sleep-request 10-20 `
>>   "https://www.instagram.com/explore/tags/southpark/" `
>>   --filter "extension in ('jpg', 'jpeg', 'png', 'webp')"
```